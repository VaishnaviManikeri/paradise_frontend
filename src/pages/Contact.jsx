...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: '📍', title: 'Address', details: ['Dr. Sudhakarrao Jadhavar Educational Campus 1, Manaji Nagar, Pune, Maharashtra 411041'] },
    { icon: '📞', title: 'Phone', details: ['+91 845 978 1648', '+91 845 977 7988'] },
    { icon: '✉️', title: 'Email', details: ['cbsejadhavar@gmail.com'] },
